...
class MyAppState extends ChangeNotifier {
  ...
  void removeFavorite({word = WordPair}) {
...
class FavoritesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var likedWords = appState.favorites
        .map((e) => Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                BigCard(pair: e),
                ElevatedButton(
                    onPressed: () {
                      appState.removeFavorite(word: e);
                    },
    ...
    return Center(
      child: Column(
          mainAxisAlignment: MainAxisAlignment.center, children: likedWords),
    );
  }
}
