...
import 'package:vamonos_mgp/components/navigation/drawer.dart';
import 'package:vamonos_mgp/components/navigation/menu_button.dart';
import 'package:vamonos_mgp/providers/home_provider.dart';
import 'package:vamonos_mgp/components/main_landing_page/sliding_up_drawer.dart';
import 'package:vamonos_mgp/components/main_landing_page/map.dart';
              ...
              children: <Widget>[
                SlidingUpPanel(
                    ...
                    onPanelSlide: (double pos) => state.updateFabHeight(pos *
                            (state.panelHeightOpen - state.panelHeightClosed) +
                        state.initFabHeight)),
                RecenterMapButton(
